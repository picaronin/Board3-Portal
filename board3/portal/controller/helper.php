...
class helper
{
	...
	* @param \phpbb\config\db_text $config_text phpBB Config Text object
	...
	*/
	public function __construct($auth, $portal_columns, $config, $config_text, $language, $template, $user, $path_helper, $portal_helper, $phpbb_root_path, $php_ext)
	{
		$this->auth = $auth;
	...
	*/
	...
	{
		$use_fa = 0;
		$fa_styles = explode(';', $this->config_text->get('board3_portal_fa_styles'));
