...
/**
*
* @package Board3 Portal v2.2 - News
...
$lang = array_merge($lang, array(
	'LATEST_NEWS'			=> 'Últimos Mensajes',
	'READ_FULL'				=> 'Leer todo',
	'NO_NEWS'				=> 'No hay Mensajes',
	...
	// ACP
	'ACP_PORTAL_NEWS_SETTINGS'		=> 'Configuración de Últimos Mensajes',
	'ACP_PORTAL_NEWS_SETTINGS_EXP'	=> 'Aquí es donde puede personalizar el bloque de Últimos Mensajes.',
	'PORTAL_NEWS_STYLE'				=> 'Compactar el estilo del bloque Últimos Mensajes',
	'PORTAL_NEWS_STYLE_EXP'			=> '"Sí" significa usar el estilo compacto para las Últimos Mensajes. "No" significa usar el estilo grande (ver texto).',
	'PORTAL_SHOW_ALL_NEWS'			=> 'Mostrar todos los artículos en este foro',
	'PORTAL_SHOW_ALL_NEWS_EXP'		=> 'Incluye temas fijos.',
	'PORTAL_NUMBER_OF_NEWS'			=> 'Número de Últimos Mensajes en el Portal',
	'PORTAL_NUMBER_OF_NEWS_EXP'		=> '0 significa infinito.',
	'PORTAL_NEWS_LENGTH'			=> 'Longitud máxima de cada Mensaje',
	'PORTAL_NEWS_LENGTH_EXP'		=> '0 significa infinito.',
	'PORTAL_NEWS_FORUM'				=> 'Foros de Últimos Mensajes',
	'PORTAL_NEWS_FORUM_EXP'			=> 'Foro(s) del cual queremos mostrar los Últimos Mensajes. Dejar en blanco para mostrar los Últimos Mensajes de todos los foros. Si "Excluir foros" se establece en "Si", seleccione el/los foro(s) que desea excluir.<br />Si "Excluir foros" se establece en "No" seleccione el/los foro(s) que desea ver.<br />Seleccione/Deseleccione múltiples foros manteniendo la tecla <samp>CTRL</samp> presionada y haciendo clic.',
	'PORTAL_NEWS_EXCLUDE'			=> 'Excluir foros',
	'PORTAL_NEWS_EXCLUDE_EXP'		=> 'Seleccione "Sí" si quiere excluir los foros seleccionados del bloque de Últimos Mensajes, y "No" si desea ver sólo los foros seleccionados en el bloque de Últimos Mensajes.',
	'PORTAL_NEWS_PERMISSIONS'		=> 'Habilitar/Deshabilitar permisos',
	'PORTAL_NEWS_PERMISSIONS_EXP'	=> 'Tener en cuenta permisos de visualización de foros para mostrar los Últimos Mensajes.',
	'PORTAL_NEWS_SHOW_LAST'			=> 'Ordenar empezando por el mensaje mas reciente',
	'PORTAL_NEWS_SHOW_LAST_EXP'		=> 'Cuando está activada, los Últimos Mensajes serán ordenadas según el mensaje mas reciente. Cuando está desactivada, los Últimos Mensajes serán ordenadas según el tema mas reciente.',
